...
//		@WebInitParam(name = "notCheckURLList", value = "/hwx/Login4Manager.jsp;/hwx/Login.jsp;/zjx/usermain.jsp;"
//				+ "/zjx/myexam.jsp;/zjx/waitexam.jsp;/zjx/examming.jsp;/zjx/endexam.jsp"),
//		@WebInitParam(name = "redirectURL", value = "/hwx/Login4Manager.jsp"), })
...
//		if ((!checkRequestURIIntNotFilterList(request)) && session.getAttribute("mname") == null) {
